...
import SettingsNavigation, { SettingsTab } from '../settings/SettingsNavigation';

const swatchTabs: SettingsTab[] = [
  {
    id: 'general',
    label: __('General', 'flexa-extra'),
    icon: Palette,
    description: __('Enable, size & shape', 'flexa-extra'),
  },
  {
    id: 'display',
    label: __('Display', 'flexa-extra'),
    icon: Eye,
    description: __('Labels & visibility', 'flexa-extra'),
  },
  {
    id: 'appearance',
    label: __('Appearance', 'flexa-extra'),
    icon: Ruler,
    description: __('Sizes & colors', 'flexa-extra'),
  },
  {
    id: 'availability',
    label: __('Availability', 'flexa-extra'),
    icon: Slash,
    description: __('Stock & unavailable', 'flexa-extra'),
  },
  {
    id: 'shop',
    label: __('Shop pages', 'flexa-extra'),
    icon: Store,
    description: __('Loop swatches', 'flexa-extra'),
  },
];
 ...
 * just the swatch controls. Laid out with a left tab rail to match the
 * Product Options settings screen.
 */
export default function VariationSwatchesSettings() {
  ...
  return (
    <FormProvider {...form}>
      <form id="flexa-extra-vswatch-settings-form" onSubmit={form.handleSubmit(onSubmit)}>
        <div className="mx-auto mt-8 min-h-screen max-w-7xl space-y-6 px-6 pb-16">
          ...
          <div className="flex flex-col gap-8 lg:flex-row">
            <SettingsNavigation activeTab={activeTab} setActiveTab={setActiveTab} tabs={swatchTabs} />
