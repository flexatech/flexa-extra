    ...
    <div className="mx-auto mt-8 max-w-4xl space-y-6 px-6 pb-16">
      ...
      {!isLoading && !isError && (sources ?? []).length === 0 && (
        <div className="border-border text-muted-foreground flex items-center gap-2 rounded-lg border border-dashed p-6 text-sm">
          ...
          {__(
            'No supported plugins were found on this site. Import sources appear here only once a plugin like YayExtra, ThemeHigh "Extra Product Options", WooCommerce Product Add-Ons or YITH WooCommerce Product Add-Ons has been installed and has data to bring over.',
            'flexa-extra',
          )}
        </div>
      )}
